...
from .models import db, User, Business, Charity, Order, Item
...
from .api.charity_routes import charity_routes
...
app.register_blueprint(charity_routes, url_prefix='/api/give')
db.init_app(app)
Migrate(app, db)
